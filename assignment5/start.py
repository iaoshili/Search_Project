...
def main():
	doc_process_args = "python assignment4/coordinator.py --mapperPath=assignment4/document_store/doc_mapper.py --reducerPath=assignment4/document_store/doc_reducer.py --jobPath=assignment5/jobPath --numReducers=%d" % NUM_REDUCERS
	...
	inverted_process_args = "python assignment4/coordinator.py --mapperPath=assignment4/inverted_index/index_mapper.py --reducerPath=assignment4/inverted_index/index_reducer.py --jobPath=assignment5/jobPath --numReducers=%d" % NUM_REDUCERS
	...
	tf_idf_args = "python assignment4/coordinator.py --mapperPath=assignment4/idf_index/idf_mapper.py --reducerPath=assignment4/idf_index/idf_reducer.py --jobPath=assignment5/jobPath --numReducers=1" 
